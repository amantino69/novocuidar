...
\restrict 6DDtaYAvYb3RfrlfkIiUNwoTaOzMBGGCMotBrs9d136dgbN4j6R37OUvvVKcJau
...
ALTER TABLE IF EXISTS ONLY public."Schedules" DROP CONSTRAINT IF EXISTS "FK_Schedules_Users_ProfessionalId";
ALTER TABLE IF EXISTS ONLY public."ScheduleBlocks" DROP CONSTRAINT IF EXISTS "FK_ScheduleBlocks_Users_ProfessionalId";
ALTER TABLE IF EXISTS ONLY public."ScheduleBlocks" DROP CONSTRAINT IF EXISTS "FK_ScheduleBlocks_Users_ApprovedBy";
ALTER TABLE IF EXISTS ONLY public."ProfessionalProfiles" DROP CONSTRAINT IF EXISTS "FK_ProfessionalProfiles_Users_UserId";
ALTER TABLE IF EXISTS ONLY public."ProfessionalProfiles" DROP CONSTRAINT IF EXISTS "FK_ProfessionalProfiles_Specialties_SpecialtyId";
ALTER TABLE IF EXISTS ONLY public."ProfessionalProfiles" DROP CONSTRAINT IF EXISTS "FK_ProfessionalProfiles_ProfessionalCouncils_CouncilId";
ALTER TABLE IF EXISTS ONLY public."ProfessionalProfiles" DROP CONSTRAINT IF EXISTS "FK_ProfessionalProfiles_CboOccupations_CboOccupationId";
ALTER TABLE IF EXISTS ONLY public."Prescriptions" DROP CONSTRAINT IF EXISTS "FK_Prescriptions_Users_ProfessionalId";
ALTER TABLE IF EXISTS ONLY public."Prescriptions" DROP CONSTRAINT IF EXISTS "FK_Prescriptions_Users_PatientId";
ALTER TABLE IF EXISTS ONLY public."Prescriptions" DROP CONSTRAINT IF EXISTS "FK_Prescriptions_Appointments_AppointmentId";
...
ALTER TABLE IF EXISTS ONLY public."MedicalReports" DROP CONSTRAINT IF EXISTS "FK_MedicalReports_Users_ProfessionalId";
ALTER TABLE IF EXISTS ONLY public."MedicalReports" DROP CONSTRAINT IF EXISTS "FK_MedicalReports_Users_PatientId";
ALTER TABLE IF EXISTS ONLY public."MedicalReports" DROP CONSTRAINT IF EXISTS "FK_MedicalReports_Appointments_AppointmentId";
ALTER TABLE IF EXISTS ONLY public."MedicalCertificates" DROP CONSTRAINT IF EXISTS "FK_MedicalCertificates_Users_ProfessionalId";
ALTER TABLE IF EXISTS ONLY public."MedicalCertificates" DROP CONSTRAINT IF EXISTS "FK_MedicalCertificates_Users_PatientId";
ALTER TABLE IF EXISTS ONLY public."MedicalCertificates" DROP CONSTRAINT IF EXISTS "FK_MedicalCertificates_Appointments_AppointmentId";
ALTER TABLE IF EXISTS ONLY public."Invites" DROP CONSTRAINT IF EXISTS "FK_Invites_Users_CreatedBy";
ALTER TABLE IF EXISTS ONLY public."ExamRequests" DROP CONSTRAINT IF EXISTS "FK_ExamRequests_Users_ProfessionalId";
ALTER TABLE IF EXISTS ONLY public."ExamRequests" DROP CONSTRAINT IF EXISTS "FK_ExamRequests_Users_PatientId";
ALTER TABLE IF EXISTS ONLY public."ExamRequests" DROP CONSTRAINT IF EXISTS "FK_ExamRequests_Appointments_AppointmentId";
ALTER TABLE IF EXISTS ONLY public."DigitalCertificates" DROP CONSTRAINT IF EXISTS "FK_DigitalCertificates_Users_UserId";
ALTER TABLE IF EXISTS ONLY public."AuditLogs" DROP CONSTRAINT IF EXISTS "FK_AuditLogs_Users_UserId";
ALTER TABLE IF EXISTS ONLY public."AuditLogs" DROP CONSTRAINT IF EXISTS "FK_AuditLogs_Users_PatientId";
ALTER TABLE IF EXISTS ONLY public."Attachments" DROP CONSTRAINT IF EXISTS "FK_Attachments_Appointments_AppointmentId";
ALTER TABLE IF EXISTS ONLY public."Appointments" DROP CONSTRAINT IF EXISTS "FK_Appointments_Users_ProfessionalId";
ALTER TABLE IF EXISTS ONLY public."Appointments" DROP CONSTRAINT IF EXISTS "FK_Appointments_Users_PatientId";
ALTER TABLE IF EXISTS ONLY public."Appointments" DROP CONSTRAINT IF EXISTS "FK_Appointments_Specialties_SpecialtyId";
DROP INDEX IF EXISTS public."IX_Users_Phone";
DROP INDEX IF EXISTS public."IX_Users_Email";
DROP INDEX IF EXISTS public."IX_Users_Cpf";
DROP INDEX IF EXISTS public."IX_SigtapProcedures_Code";
DROP INDEX IF EXISTS public."IX_Schedules_ProfessionalId";
DROP INDEX IF EXISTS public."IX_ScheduleBlocks_ProfessionalId";
DROP INDEX IF EXISTS public."IX_ScheduleBlocks_ApprovedBy";
DROP INDEX IF EXISTS public."IX_ProfessionalProfiles_UserId";
DROP INDEX IF EXISTS public."IX_ProfessionalProfiles_SpecialtyId";
DROP INDEX IF EXISTS public."IX_ProfessionalProfiles_Crm";
DROP INDEX IF EXISTS public."IX_ProfessionalProfiles_CouncilRegistration";
DROP INDEX IF EXISTS public."IX_ProfessionalProfiles_CouncilId";
DROP INDEX IF EXISTS public."IX_ProfessionalProfiles_CboOccupationId";
DROP INDEX IF EXISTS public."IX_ProfessionalCouncils_Acronym";
DROP INDEX IF EXISTS public."IX_Prescriptions_ProfessionalId";
DROP INDEX IF EXISTS public."IX_Prescriptions_PatientId";
DROP INDEX IF EXISTS public."IX_Prescriptions_DocumentHash";
DROP INDEX IF EXISTS public."IX_Prescriptions_AppointmentId";
DROP INDEX IF EXISTS public."IX_PatientProfiles_UserId";
DROP INDEX IF EXISTS public."IX_PatientProfiles_Cns";
DROP INDEX IF EXISTS public."IX_Notifications_UserId";
DROP INDEX IF EXISTS public."IX_MedicalReports_ProfessionalId";
DROP INDEX IF EXISTS public."IX_MedicalReports_PatientId";
DROP INDEX IF EXISTS public."IX_MedicalReports_DocumentHash";
DROP INDEX IF EXISTS public."IX_MedicalReports_AppointmentId";
DROP INDEX IF EXISTS public."IX_MedicalCertificates_ProfessionalId";
DROP INDEX IF EXISTS public."IX_MedicalCertificates_PatientId";
DROP INDEX IF EXISTS public."IX_MedicalCertificates_DocumentHash";
DROP INDEX IF EXISTS public."IX_MedicalCertificates_AppointmentId";
DROP INDEX IF EXISTS public."IX_Invites_Token";
DROP INDEX IF EXISTS public."IX_Invites_Email";
DROP INDEX IF EXISTS public."IX_Invites_CreatedBy";
DROP INDEX IF EXISTS public."IX_ExamRequests_ProfessionalId";
DROP INDEX IF EXISTS public."IX_ExamRequests_PatientId";
DROP INDEX IF EXISTS public."IX_ExamRequests_DocumentHash";
DROP INDEX IF EXISTS public."IX_ExamRequests_AppointmentId";
DROP INDEX IF EXISTS public."IX_DigitalCertificates_UserId";
DROP INDEX IF EXISTS public."IX_DigitalCertificates_Thumbprint";
DROP INDEX IF EXISTS public."IX_CboOccupations_Code";
DROP INDEX IF EXISTS public."IX_AuditLogs_UserId";
DROP INDEX IF EXISTS public."IX_AuditLogs_PatientId";
DROP INDEX IF EXISTS public."IX_AuditLogs_PatientCpf";
DROP INDEX IF EXISTS public."IX_AuditLogs_CreatedAt";
DROP INDEX IF EXISTS public."IX_AuditLogs_Action";
DROP INDEX IF EXISTS public."IX_Attachments_AppointmentId";
DROP INDEX IF EXISTS public."IX_Appointments_SpecialtyId";
DROP INDEX IF EXISTS public."IX_Appointments_ProfessionalId";
...
ALTER TABLE IF EXISTS ONLY public."Specialties" DROP CONSTRAINT IF EXISTS "PK_Specialties";
ALTER TABLE IF EXISTS ONLY public."SigtapProcedures" DROP CONSTRAINT IF EXISTS "PK_SigtapProcedures";
ALTER TABLE IF EXISTS ONLY public."Schedules" DROP CONSTRAINT IF EXISTS "PK_Schedules";
ALTER TABLE IF EXISTS ONLY public."ScheduleBlocks" DROP CONSTRAINT IF EXISTS "PK_ScheduleBlocks";
ALTER TABLE IF EXISTS ONLY public."ProfessionalProfiles" DROP CONSTRAINT IF EXISTS "PK_ProfessionalProfiles";
ALTER TABLE IF EXISTS ONLY public."ProfessionalCouncils" DROP CONSTRAINT IF EXISTS "PK_ProfessionalCouncils";
...
ALTER TABLE IF EXISTS ONLY public."MedicalReports" DROP CONSTRAINT IF EXISTS "PK_MedicalReports";
ALTER TABLE IF EXISTS ONLY public."MedicalCertificates" DROP CONSTRAINT IF EXISTS "PK_MedicalCertificates";
ALTER TABLE IF EXISTS ONLY public."Invites" DROP CONSTRAINT IF EXISTS "PK_Invites";
ALTER TABLE IF EXISTS ONLY public."ExamRequests" DROP CONSTRAINT IF EXISTS "PK_ExamRequests";
ALTER TABLE IF EXISTS ONLY public."DigitalCertificates" DROP CONSTRAINT IF EXISTS "PK_DigitalCertificates";
ALTER TABLE IF EXISTS ONLY public."CboOccupations" DROP CONSTRAINT IF EXISTS "PK_CboOccupations";
...
DROP TABLE IF EXISTS public."SigtapProcedures";
DROP TABLE IF EXISTS public."Schedules";
DROP TABLE IF EXISTS public."ScheduleBlocks";
DROP TABLE IF EXISTS public."ProfessionalProfiles";
DROP TABLE IF EXISTS public."ProfessionalCouncils";
DROP TABLE IF EXISTS public."Prescriptions";
DROP TABLE IF EXISTS public."PatientProfiles";
DROP TABLE IF EXISTS public."Notifications";
DROP TABLE IF EXISTS public."MedicalReports";
DROP TABLE IF EXISTS public."MedicalCertificates";
DROP TABLE IF EXISTS public."Invites";
DROP TABLE IF EXISTS public."ExamRequests";
DROP TABLE IF EXISTS public."DigitalCertificates";
DROP TABLE IF EXISTS public."CboOccupations";
...
97a70547-5fa9-420d-a634-f13730db5edd	62f70bc8-e96e-4308-bffc-15bcada66ed7	dc42f275-da07-437e-9c47-32100563d610	f5196497-9f26-4f98-a240-1bb0c8c60639	2026-02-06T00:00:00.0000000	08:00:00	08:30:00	0	3	Consulta de primeira vez - POC TeleCuidar	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-02-05T10:29:26.7494083Z	2026-02-05T13:20:15.2872704Z	\N	\N	\N	\N	\N	\N	0	\N	2026-02-05T13:20:15.2795464Z	0	0	\N	\N	\N
...
c8d3e9ae-1b97-4758-8789-5ef40dd70abb	med_aj@telecuidar.com	$2a$12$gxgsTSicLFvsICPeX8JgU.i2F1t4fj0KoHX.2EgO6FoYsrVpj/2A.	Ant├┤nio	Jorge	90000000000	11900000000	\N	1	0	1	\N	\N	\N	\N	\N	\N	\N	PzyZemyDdS0aMml4v5Vo2S3SxxfDciPdms4YCKs0Imo=	2026-02-06T14:24:38.5755348Z	2026-02-05T10:29:26.3478973Z	2026-02-05T14:24:38.5757203Z
dc42f275-da07-437e-9c47-32100563d610	med_gt@telecuidar.com	$2a$12$gxgsTSicLFvsICPeX8JgU.i2F1t4fj0KoHX.2EgO6FoYsrVpj/2A.	Geraldo	Tadeu	90000000001	11900000001	\N	1	0	1	\N	\N	\N	\N	\N	\N	\N	sxGlodt+y2+UzJ8mTg/CaPmxeMNYMDTu5FwR27PLT5U=	2026-02-06T17:51:52.5274482Z	2026-02-05T10:29:26.3908697Z	2026-02-05T17:51:52.5276623Z
0f8e0f55-b270-46d7-bf58-8831e5705cf8	enf_do@telecuidar.com	$2a$12$gxgsTSicLFvsICPeX8JgU.i2F1t4fj0KoHX.2EgO6FoYsrVpj/2A.	Daniela	Ochoa	90000000007	11900000007	\N	3	0	1	\N	\N	\N	\N	\N	\N	\N	WlNd9lrJsOTkFqwtgx8xhW6irPeNWupyzAFAJxm8l/0=	2026-02-06T16:02:49.2195452Z	2026-02-05T10:29:26.6068014Z	2026-02-05T16:02:49.2196347Z
\.
...
\unrestrict 6DDtaYAvYb3RfrlfkIiUNwoTaOzMBGGCMotBrs9d136dgbN4j6R37OUvvVKcJau
